...
export const tellorAddressMumbai = '0x3251838bd813fdf6a97D32781e011cce8D225d59'
...
export const daiAddressPulsechain = '0xefD766cCb38EaF1dfd701853BFCe31359239F305'
...
export const autopayFileMain = ' 0x3b50dEc3CA3d34d5346228D86D29CF679EAA0Ccb'
export const autopayCalibration = '0x60cBf3991F05a0671250e673Aa166e9D1A0C662E'
export const autopaySepolia = '0xB59a8085b4C360a3694396CA8E09441052656cF6'
export const autopayGnosismain = ' 0x3b50dEc3CA3d34d5346228D86D29CF679EAA0Ccb'
export const autopayChiado = '0x9BE9B0CFA89Ea800556C6efbA67b455D336db1D0'
export const autopayOpmain = '0x3b50dEc3CA3d34d5346228D86D29CF679EAA0Ccb'
...
export const getAssetBalances = async (web3, address, chainId) => {
  ...
  switch (chainId) {
    ...
    case 4:
      ...
      case 369:
        //Main Chain Balance - Pulsechain Mainnet
        chainMainTokenBalance = web3.utils.fromWei(
          await web3.eth.getBalance(address)
        )
        trbBalance = await daiContractPulsechain.methods
          .balanceOf(address)
          .call()
          .then((res) => web3.utils.fromWei(res))
        //Add more assets here if needed
